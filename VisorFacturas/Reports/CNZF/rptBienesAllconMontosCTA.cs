...
{
    public partial class rptBienesAllconMontosCTA : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        String c_codigo;
        public rptBienesAllconMontosCTA(List<viewBIENES> paListBIENES)//(mstcia pocia)
        {
            InitializeComponent();            
