...
{
    public partial class xrestado_cta_cliente_CZF : DevExpress.XtraReports.UI.XtraReport
    {
        decimal aosdo_ACUM = 0, aosdo_ANT = 0;
        public xrestado_cta_cliente_CZF()
        {
            InitializeComponent();
        }
        ...
        {
            view_rpt_saldoclientes_CZF aocurrent = (view_rpt_saldoclientes_CZF)this.GetCurrentRow();
            if (aocurrent != null)
            {
